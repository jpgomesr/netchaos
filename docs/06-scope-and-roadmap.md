...
Decided by the maintainer against [M8-7](tasks/m8-v1-readiness.md#m8-7--api-ergonomics-review-of-the-v020-surface-the-v100-gate)'s recommendations — see that task's "Review outcome" section for the full reasoning per finding. **Accepted means in scope, not implemented** — each item below gets its own task and its own PR under [M9 — v1.0.0 surface additions](tasks/m9-v1-surface-additions.md), which also sequences them; this section stays the record of *what* was accepted and why.
