...
## Reordering: in or out of v1?

**This needs a decision before v1 API design is finalized.** As detailed in [05 — Fault Injection](05-fault-injection.md#reordering-open-question), the README's introductory prose lists reordering as a fault type, but the v1 checklist above doesn't include it. Until resolved, treat reordering as **not yet in scope** — it is not listed in the checklist and this doc will only add it once explicitly decided.

## Explicitly out of scope for v1

The README lists these directly:
