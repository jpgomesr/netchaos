...
| [M9 — v1.0.0 surface additions](m9-v1-surface-additions.md) | *(none — post-v1)* | Open. Implements what `M8-7` recommended and the maintainer accepted: `#83`, `#86`, `#78` (partial), `#85` (partial) — one task and one PR per item, following the `M6`→`M7` precedent. Does not itself schedule the `v1.0.0` tag. |
